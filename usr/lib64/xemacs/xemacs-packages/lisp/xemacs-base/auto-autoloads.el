...
(package-provide 'xemacs-base :version 2.27 :author-version "No-Upstream-Ver" :type 'regular)
...
;;;***

;;;### (autoloads nil "autoload-operators" "xemacs-base/autoload-operators.el")
...
;;;***

;;;### (autoloads (first-error previous-error next-error compilation-minor-mode compilation-shell-minor-mode compilation-mode grep-all-files-in-current-directory-and-below grep-all-files-in-current-directory grep-find grep compile compilation-search-path compilation-finish-function compilation-buffer-name-function compilation-window-height compilation-mode-hook) "compile" "xemacs-base/compile.el")
...
;;;***

;;;### (autoloads (field-at-pos constrain-to-field field-end field-beginning field-string-no-properties field-string delete-field make-field) "field" "xemacs-base/field.el")
...
buffer's accessible portion." nil nil)
...
(autoload 'field-at-pos "field" "\
Return the field at position POS, taking openness/closedness into account." nil nil)
...
\(parenthesized expressions) in REGEXP." nil nil)
...
;;;***

;;;### (autoloads (shell shell-prompt-pattern shell-dumb-shell-regexp) "shell" "xemacs-base/shell.el")
...
For example: to sort lines in the region by the numerical value of the first
 ...
 RECORD-REGEXP would be \"^.*$\" and KEY would be \"0[xX][0-9A-Fa-f]+\"" t nil)
