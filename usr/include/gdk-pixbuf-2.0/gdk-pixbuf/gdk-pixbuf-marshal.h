...
/* VOID:VOID (/var/tmp/portage/x11-libs/gdk-pixbuf-2.36.11/work/gdk-pixbuf-2.36.11/gdk-pixbuf/gdk-pixbuf-marshal.list:25) */
#define _gdk_pixbuf_marshal_VOID__VOID	g_cclosure_marshal_VOID__VOID

/* VOID:INT,INT (/var/tmp/portage/x11-libs/gdk-pixbuf-2.36.11/work/gdk-pixbuf-2.36.11/gdk-pixbuf/gdk-pixbuf-marshal.list:26) */
...
/* VOID:INT,INT,INT,INT (/var/tmp/portage/x11-libs/gdk-pixbuf-2.36.11/work/gdk-pixbuf-2.36.11/gdk-pixbuf/gdk-pixbuf-marshal.list:27) */
...
/* VOID:POINTER (/var/tmp/portage/x11-libs/gdk-pixbuf-2.36.11/work/gdk-pixbuf-2.36.11/gdk-pixbuf/gdk-pixbuf-marshal.list:28) */
